...
# class TestShopUserCreationForm(TestCase):
#     @classmethod
#     def setUpTestData(cls):
#         ShopUser.objects.create_user(phone='09123456789', password="123456")
#
#     def test_valid_phone_number(self):
#         form = ShopUserCreationForm(data={
#             'phone': '09123456781',
...
#         self.assertEqual(form.errors['phone'], ['This phone number is already taken'])
#
#     def test_phone_number_not_digit(self):
#         form = ShopUserCreationForm(data={
#             'phone': '091@34!67m9',
#             'password1': 'ComplexPass123!',
#             'password2': 'ComplexPass123!'
#         })
#         self.assertFalse(form.is_valid())
#         self.assertEqual(form.errors['phone'], ['Phone number is invalid'])
#
...
#         })
#         self.assertFalse(form.is_valid())
#         self.assertEqual(form.errors['phone'], ['Phone number must have 11 digits'])
#
#         # Test long number
#         form = ShopUserCreationForm(data={
#             'phone': '091234567890',
...
#         })
#         self.assertFalse(form.is_valid())
#         self.assertEqual(form.errors['phone'], ["Phone number must start with '09'"])
